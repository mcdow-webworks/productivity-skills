...
When errors occur, inform the user clearly and suggest corrective action (see [reference/TROUBLESHOOTING.md](reference/TROUBLESHOOTING.md)).
...
See [reference/WORKFLOW.md](reference/WORKFLOW.md) for detailed decision trees.
...
- **API Reference**: [docs/API.md](docs/API.md) - All commands with schemas
- **Search Algorithm**: [reference/ALGORITHM.md](reference/ALGORITHM.md) - Relevance scoring details
- **Workflow Guide**: [reference/WORKFLOW.md](reference/WORKFLOW.md) - Decision trees and patterns
